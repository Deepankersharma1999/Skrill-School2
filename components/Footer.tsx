    ...
    return (
        <footer className="bg-o text-white relative lg:px-20 px-5 max-w-[1270px]  rounded-[50px] mx-auto mt-20 py-20 z-0 overflow-hidden">
            ...
            <div className="mx-auto flex flex-col lg:flex-row justify-between max-w-6xl items-center mt-10 z-10">
                {/* bottom left div */}
                <div className="flex flex-col gap-5 justify-center bg-orange-500 p-5 rounded-[25px] w-auto">
                    <h3 className="font-bold mb-4 lg:text-2xl text-xl text-center">Before you go check<br /> these links</h3>
                ...
                {/* bottom right div */}
                <div className="flex flex-col lg:mt-0 mt-10 w-auto gap-5">
                    ...
                    <div className="flex relative z-10 justify-center space-x-3 rounded-[25px]">
